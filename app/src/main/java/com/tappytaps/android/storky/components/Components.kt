...
import com.tappytaps.android.storky.utils.convertCalendarToText
import com.tappytaps.android.storky.utils.convertSecondsToTimeString
import com.tappytaps.android.storky.utils.getFormattedDate
...
fun UniversalButton(
    ...
    {
        val buttonModifier = if (sendButton) {
            Modifier
                .height(56.dp)
                .width(296.dp)
    ...
    private fun UniversalButtonPreview() {
        UniversalButton("text", onClick = { }, sendButton = true)
    }
